      ...
      <Container>
        <div id="speakers" className={styles.container}>
          ...
          <p className={styles.Description}>
            O time de palestrantes do Devfest Sudeste 2022 traz grandes nomes da
          ...
          <div className={styles.button_container}>
            <Button color="primary" href="/speakers">
          ...
          <p className={styles.Description}>
            Com muita alegria anuciamos que nosso Call for Papers está aberto e
            esperamos muitas submissões de palestras para o DevFest Sudeste!!! O
            nosso evento ocorrerá nos dias 16 e 17/12 e será TOTALMENTE online.
            Quer compartilhar seu conhecimento com a galera? Submeta sua
            palestra para o nosso DevFest!!!
          </p>
          <Badge className={styles.BadgeStyle} color="danger">
